# -*- coding: utf-8 -*-
"""AR2_Document_Epoch_6_d_model_256_4_Seeds_One_Realization_Jesse_Price.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nEJ5pXwA3ieKreJwS5Xe12XCAYRzSeYB
...
!zip -r ar2_variance_check_og_params_Epoch_6_d_model_256_4_Seeds_One_Realization_folders.zip ar2*_folder
files.download("ar2_variance_check_og_params_Epoch_6_d_model_256_4_Seeds_One_Realization_folders.zip")
...
e_layers = 2
d_layers = 1
factor = 3 --> 1 good as is but can change
enc_in = 1 --> 7 good as is
dec_in = 1 --> 7 good as is
c_out = 1 --> 7 good as is
d_model = 128 --> 512 Need to change
train_epochs = 1 --> 10 Need to change
seed_fedformer = 42 --> 2021 good as is
old_name = 'train'
new_name = 'test'